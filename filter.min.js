...
d=[],e=RegExp("(^| )"+b+"( |$)"),g=0;g<c.length;g++)e.test(c[g].className)&&d.push(c[g]);return d};return{Init:function(){var a=localStorage.githubNewsFilterVersion;if(!a||a!=="0.3.0")console.log("oldversion"),localStorage.removeItem("filters"),localStorage.githubNewsFilterVersion="0.3.0";localStorage.filters?d=JSON.parse(localStorage.filters):(d={issueComment:{text:"Issue Comment",id:"issues_comment",checked:!1},pullRequest:{text:"Pull Request & Issue Opened",id:"issues_opened",checked:!1},follow:{text:"Follow",
id:"follow",checked:!1},gist:{text:"Gist",id:"gist",checked:!1},push:{text:"Push",id:"push",checked:!1},created:{text:"Created Branch",id:"create",checked:!1},issueClosed:{text:"Close & Merge",id:"issues_closed",checked:!1},fork:{text:"Forked",id:"fork",checked:!1},watch:{text:"Watch",id:"watch_started",checked:!1},editWiki:{text:"Wiki",id:"gollum",checked:!1}},localStorage.filters=JSON.stringify(d));a=document.createElement("div");a.id="filterDiv";a.className="filterBar";document.getElementById("footer").appendChild(a);
e=a;r();o();for(var b in d){a=k("input",b,b,d[b].id,{type:"checkbox"});s(a);if(d[b].checked)a.checked=!0;var c=k("label");c.innerHTML=d[b].text;var f=k("span");f.className="filterOption";f.appendChild(c);f.appendChild(a);i.push(a);e.appendChild(f)}p();q()}}}();filterObj.Init();
